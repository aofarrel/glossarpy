...
class GreatGloss(GlossTxt.GlossTxt):
    ...
    def add_source(self, format:str = "rst"):
        '''Include a note (as a comment if rst) on entry file to note it was created programatically'''
        message = """DO NOT EDIT THIS FILE. Update the Python source file that this page was generated from instead."""
        if format == "rst":
            return(f".. {message}\n\n")
        else:
            return message
    ...
    def make_toc(self, format:str, columns:int = 3):
    ...
    def write_glossary(self, outfile:str = "", format:str = "rst", skipTOC:bool = False, skipSource:bool = False):
    ...
    def write_toc(self, outtoc:str = "", format:str = "rst", columns:int = 0):
